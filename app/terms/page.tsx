...
export default function TermsPage() {
  ...
  return (
    <div className="flex flex-col w-full bg-white text-black min-h-screen">
      ...
      <section className="bg-jute-base pt-15 pb-15 px-6 text-center border-b border-gray-200">
        <div className="max-w-4xl mx-auto flex flex-col items-center">
          ...
          <h1 className="font-serif text-4xl md:text-5xl font-bold mb-6 tracking-tight text-forest-slate">
            Terms & <span className="text-terracotta italic font-light">Conditions</span>
          </h1>
